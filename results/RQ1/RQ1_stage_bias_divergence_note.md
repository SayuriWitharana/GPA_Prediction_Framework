...
(model predicts too high) — see `src/rq1/external_bootstrap.py` and
...
- Stage-1: `results/RQ1/cv_results.csv`, generated by `src/rq1/cv.py`.
- Stage-2: `results/RQ1/external_bootstrap_ci.csv`, generated by
  `src/rq1/external_bootstrap.py` (95% bootstrap CIs; point estimates used above).
