...
(model predicts too high) — see `src/rq1_external_bootstrap.py` and
`RidgeRegression2017-2018.ipynb`.
...
- Stage-1: `notebooks/rq1_reliability/cv_results.csv`, generated by `src/rq1_cv.py`.
- Stage-2: `notebooks/rq1_reliability/external_bootstrap_ci.csv`, generated by
  `src/rq1_external_bootstrap.py` (95% bootstrap CIs; point estimates used above).
